...
<template>
  <section id="about" class="py-20 px-6 bg-zinc-900">
    <div class="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
      <div>
        <img
          src="https://images.pexels.com/photos/34154100/pexels-photo-34154100.jpeg"
          alt="Arun"
          class="about-profile-photo w-full h-auto rounded-lg"
        />
      </div>
      <div>
        ...
        <p class="text-gray-400 mb-6 leading-relaxed">
          ...
          pushes creative boundaries. Each image is carefully crafted to evoke
          emotion and capture the unique essence of my subjects.
        </p>
